...
public partial class CentermueblesContext : DbContext
{
    ...
    // TABLAS ACTUALIZADAS - QUITAMOS CLIENTES, AGREGAMOS CARRITO
    ...
    // Configuración de tablas, columnas y relaciones ACTUALIZADA
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Producto>(entity =>
        {
            ...
            // SOLO relación con Subcategoria (quitamos IdCategoria)
        ...
        modelBuilder.Entity<Venta>(entity =>
        {
            ...
            // SOLO relación con Usuario (quitamos Clientes y Producto de Ventas)
